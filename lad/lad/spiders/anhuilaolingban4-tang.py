...
class newsSpider(BaseTimeCheckSpider):
    name = "anhuilaolingban4"
    start_urls = ['http://www.ahllb.cn/webinfo/m/chuantong/index.html']
    ...
    def parse(self, response):
        ...
        #         return
        #
        #     next_url = 'http://www.ahllb.cn/webinfo/m/chuantong/index_' + str(nextPageNum) + '.html'
