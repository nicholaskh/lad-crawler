...
class newsSpider(BaseTimeCheckSpider):
    name = "anhuilaolingban6"
    start_urls = ['http://www.ahllb.cn/webinfo/xxgk/gongkai/jiedu/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.ahllb.cn/webinfo/xxgk/gongkai/jiedu/index_' + str(nextPageNum) + '.html'
