...
class newsSpider(BaseTimeCheckSpider):
    name = "beijinggongan1"
    start_urls = ['http://www.bjgaj.gov.cn/web/listPage_jwbd_null_col1169_30_1.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            if current_pagenum < maxPageNum:
                ...
                next_url = 'http://www.bjgaj.gov.cn/web/listPage_jwbd_null_col1169_30_' + next_pagenum + '.html'
