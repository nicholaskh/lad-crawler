...
class newsSpider(BaseTimeCheckSpider):
    name = "guangdonggongan1"
    start_urls = ['http://www.gdga.gov.cn/xxgk/jfts/list.html']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            if '../..' in each:
                ...
                url = 'http://www.gdga.gov.cn/xxgk/jfts' + each[1:]
            urls.append(url)
        ...
        if should_deep:
            ...
            if continuetocrawl == True:
                ...
                next_url = 'http://www.gdga.gov.cn/xxgk/jfts/list_' + str(nextPageNum) + '.html'
