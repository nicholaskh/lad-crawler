...
class newsSpider(BaseTimeCheckSpider):
    name = "guangdonglaolingchanyexiehui1"
    start_urls = ['http://www.gdsia.org/page65']

    def parse(self, response):
        should_deep = True
        times = response.xpath('//div[@class="article_list-layer8F263F06129876688F401C3794BC6CE2"]/ul//li/p[2]/span/text()').extract()
        if len(times) == 0:
            should_deep =False
        ...
        #是相对链接
        urls_ori = response.xpath('//div[@class="article_list-layer8F263F06129876688F401C3794BC6CE2"]/ul//li/p/a/@href').extract()
        urls = []
