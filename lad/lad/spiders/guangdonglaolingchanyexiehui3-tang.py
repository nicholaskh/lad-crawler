...
class newsSpider(BaseTimeCheckSpider):
    name = "guangdonglaolingchanyexiehui3"
    start_urls = ['http://www.gdsia.org/page95']

    def parse(self, response):
        should_deep = True
        times = response.xpath('//div[@class="article_list-layer229EFABBD0E47D5C62247ABD50964BE2"]/ul//li/p[2]/span/text()').extract()
        if len(times) == 0:
            should_deep = False
        ...
        # 是相对链接
        urls_ori = response.xpath('//div[@class="article_list-layer229EFABBD0E47D5C62247ABD50964BE2"]/ul//li/p/a/@href').extract()
        urls = []
