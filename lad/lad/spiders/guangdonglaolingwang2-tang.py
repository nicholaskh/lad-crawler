...
class newsSpider(BaseTimeCheckSpider):
    name = "guangdonglaolingwang2"
    start_urls = ['http://www.gdllw.org/llyw/ldjh/default.htm']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            each = 'http://www.gdllw.org/llyw/ldjh' + each[1:]
            urls.append(each)
        ...
        if should_deep:
            ...
            next_url = 'http://www.gdllw.org/llyw/ldjh/default_' + str(nextPageNum) + '.htm'
