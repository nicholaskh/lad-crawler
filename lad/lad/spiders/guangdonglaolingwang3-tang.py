...
class newsSpider(BaseTimeCheckSpider):
    name = "guangdonglaolingwang3"
    start_urls = ['http://www.gdllw.org/llyw/ywdt/default.htm']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            each = 'http://www.gdllw.org/llyw/ywdt' + each[1:]
            urls.append(each)
        ...
        if should_deep:
            ...
            next_url = 'http://www.gdllw.org/llyw/ywdt/default_' + str(nextPageNum) + '.htm'
