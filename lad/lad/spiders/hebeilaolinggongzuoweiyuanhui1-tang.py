...
class newsSpider(BaseTimeCheckSpider):
    name = "hebeilaolinggongzuoweiyuanhui1"
    start_urls = ['http://www.hebllw.org.cn/html/news/zhengcefagui/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.hebllw.org.cn/html/news/zhengcefagui/index_' + str(nextPageNum) + '.html'
