...
class newsSpider(BaseTimeCheckSpider):
    name = "hebeilaolinggongzuoweiyuanhui3"
    start_urls = ['http://www.hebllw.org.cn/html/news/laolingxinwen/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.hebllw.org.cn/html/news/laolingxinwen/index_' + str(nextPageNum) + '.html'
