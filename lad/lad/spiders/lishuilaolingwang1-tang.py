...
class newsSpider(BaseTimeCheckSpider):
    name = "lishuilaolingwang1"
    start_urls = ['http://llw.lishui.gov.cn/zcfg/index.htm']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            each = 'http://llw.lishui.gov.cn/zcfg' + each[1:]
            urls.append(each)
        ...
        if should_deep:
            ...
            next_url = 'http://llw.lishui.gov.cn/zcfg/index_' + str(nextPageNum) + '.htm'
