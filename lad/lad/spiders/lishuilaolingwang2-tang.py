...
class newsSpider(BaseTimeCheckSpider):
    name = "lishuilaolingwang2"
    start_urls = ['http://llw.lishui.gov.cn/xwdt/index.htm']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            each = 'http://llw.lishui.gov.cn/xwdt' + each[1:]
            urls.append(each)
        ...
        if should_deep:
            ...
            next_url = 'http://llw.lishui.gov.cn/xwdt/index_' + str(nextPageNum) + '.htm'
