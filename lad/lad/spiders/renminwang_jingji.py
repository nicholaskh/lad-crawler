...
class newsSpider(BaseTimeCheckSpider):
    name = "renminwang_jingji"
    start_urls = ['http://finance.people.com.cn/GB/153179/153180/index1.html',
                  'http://finance.people.com.cn/GB/70846/index1.html',
                  'http://finance.people.com.cn/GB/153179/153522/index1.html',
                  'http://finance.people.com.cn/GB/414330/index1.html']

    def parse(self, response):
        should_deep = True
        urls = response.xpath('//div[@class="ej_left"]/ul/li/a/@href').extract()
        times = list()
    ...
    def parse_info(self, response):
        ...
        for img in img_list:
            if 'http' not in img:
                img = "http://finance.people.com.cn" + img
