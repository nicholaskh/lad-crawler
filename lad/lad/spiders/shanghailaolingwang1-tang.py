...
class newsSpider(BaseTimeCheckSpider):
    name = 'shanghailaolingwang1'
    start_urls = ['http://www.shanghai60.org.cn/list.php?catid=50&page=1']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.shanghai60.org.cn/list.php?catid=50&page=' + str(nextPageNum)
