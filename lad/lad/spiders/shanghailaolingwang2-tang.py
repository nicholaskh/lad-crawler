...
class newsSpider(BaseTimeCheckSpider):
    name = 'shanghailaolingwang2'
    start_urls = ['http://www.shanghai60.org.cn/list.php?catid=51&page=1']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.shanghai60.org.cn/list.php?catid=51&page=' + str(nextPageNum)
