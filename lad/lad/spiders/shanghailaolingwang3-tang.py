...
class newsSpider(BaseTimeCheckSpider):
    name = 'shanghailaolingwang3'
    start_urls = ['http://www.shanghai60.org.cn/list.php?catid=46&page=1']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.shanghai60.org.cn/list.php?catid=46&page=' + str(nextPageNum)
