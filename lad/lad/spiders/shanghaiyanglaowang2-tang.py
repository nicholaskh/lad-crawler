...
class newsSpider(BaseTimeCheckSpider):
    name = 'shanghaiyanglaowang2'
    start_urls = ['http://www.shanghaiyanglao.com/Detail/index?tag=&keyword=&tid=&class=90&page=1']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.shanghaiyanglao.com/Detail/index?tag=&keyword=&tid=&class=90&page=' + str(nextPageNum)
