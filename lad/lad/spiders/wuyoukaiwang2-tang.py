...
class newsSpider(BaseTimeCheckSpider):
    name = "wuyoukaowang2"
    start_urls = ['https://www.51test.net/channel_list_more.asp?page=1&classid=31&Nclassid=430&Key=&search_key=%CD%CB%D0%DD&search_key2=']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'https://www.51test.net/channel_list_more.asp?page=' + str(nextPageNum) + '&classid=31&Nclassid=430&Key=&search_key=%CD%CB%D0%DD&search_key2='
