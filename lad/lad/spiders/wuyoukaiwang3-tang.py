...
class newsSpider(BaseTimeCheckSpider):
    name = "wuyoukaowang3"
    start_urls = ['https://www.51test.net/channel_list_more.asp?page=1&classid=31&Nclassid=430&Key=&search_key=%D1%F8%C0%CF&search_key2=']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'https://www.51test.net/channel_list_more.asp?page=' + str(nextPageNum) + '&classid=31&Nclassid=430&Key=&search_key=%D1%F8%C0%CF&search_key2='
