...
class newsSpider(BaseTimeCheckSpider):
    name = 'xiamenlaolingwang2'
    start_urls = ['http://www.xmll.gov.cn/xxgk/yldt/index.htm?page=1']
    ...
    def parse(self, response):
        ...
        for each in urls_ori:
            url = 'http://www.xmll.gov.cn/xxgk/yldt' + each[1:]
            urls.append(url)
        ...
        if should_deep:
            ...
            next_url = 'http://www.xmll.gov.cn/xxgk/yldt/index_' + str(currentPageNum) + '.htm?page=' + str(nextPageNum)
