...
class newsSpider(BaseTimeCheckSpider):
    name = "xinhuawang_guoji4"
    start_urls = ['http://us.xinhuanet.com/sz.htm',
                  'http://us.xinhuanet.com/cj.htm',
                  'http://us.xinhuanet.com/pl.htm',
                  'http://us.xinhuanet.com/wt.htm',
                  'http://us.xinhuanet.com/bl.htm',
                  'http://us.xinhuanet.com/mtbd.htm',
                  'http://us.xinhuanet.com/zmjl.htm',
                  'http://us.xinhuanet.com/fc.htm']
