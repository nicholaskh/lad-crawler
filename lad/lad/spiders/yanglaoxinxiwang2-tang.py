...
class newsSpider(BaseTimeCheckSpider):
    name = "yanglaoxinxiwang2"
    start_urls = ['http://www.yanglaocn.com/yanglaoyuan/zhengcefagui/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.yanglaocn.com/yanglaoyuan/zhengcefagui/list_' + str(nextPageNum) + '.html'
