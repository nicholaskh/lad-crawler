...
class newsSpider(BaseTimeCheckSpider):
    name = "yanglaoxinxiwang3"
    start_urls = ['http://www.yanglaocn.com/yanglaoyuan/yanglaofuwu/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.yanglaocn.com/yanglaoyuan/yanglaofuwu/list_' + str(nextPageNum) + '.html'
