...
class newsSpider(BaseTimeCheckSpider):
    name = "yanglaoxinxiwang4"
    start_urls = ['http://www.yanglaocn.com/ylzx/yanglaojin/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.yanglaocn.com/ylzx/yanglaojin/list_' + str(nextPageNum) + '.html'
