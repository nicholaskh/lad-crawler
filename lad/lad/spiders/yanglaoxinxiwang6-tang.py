...
class newsSpider(BaseTimeCheckSpider):
    name = "yanglaoxinxiwang6"
    start_urls = ['http://www.yanglaocn.com/ylzx/yanglaochanye/index.html']
    ...
    def parse(self, response):
        ...
        if should_deep:
            ...
            next_url = 'http://www.yanglaocn.com/ylzx/yanglaochanye/list_' + str(nextPageNum) + '.html'
