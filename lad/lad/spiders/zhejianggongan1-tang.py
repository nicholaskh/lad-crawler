...
class newsSpider(BaseTimeCheckSpider):
    name = "zhejianggongan1"
    start_urls = ['http://www.zjsgat.gov.cn/jwzx/qgjx/index.html']
    ...
    def parse(self, response):
        ...
        for each in urls_ori2:
            if '.htm' in each:
                url = 'http://www.zjsgat.gov.cn/jwzx/qgjx' + each[1:]
                urls.append(url)
        ...
        if should_deep:
            ...
            next_url = 'http://www.zjsgat.gov.cn/jwzx/qgjx/index_' + str(nextPageNum) + '.html'
