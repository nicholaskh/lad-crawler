...
class WeChatSpider(scrapy.Spider):
    name = "jianghexing"
    start_urls = ["https://mp.weixin.qq.com/s?__biz=MzIzMTcyMzY4OA==&mid=2247486048&idx=4&sn=d4156df4badac3463a1a8f785c31d0c0&scene=21#wechat_redirect"]

    def parse(self, response):
        urls_ori =  response.xpath('//*[@id="js_content"]/section[3]/section/section/section/section/section/section/section/section/section/section/ul//a/@href').extract()
