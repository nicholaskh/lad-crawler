...
class WeChatSpider(scrapy.Spider):
    name = "xuexixiezi"
    start_urls = ['https://mp.weixin.qq.com/s?__biz=MzIzMTcyMzY4OA==&mid=2247484055&idx=2&sn=a696f4425e7373fa98bead80d0c30b20&scene=21#wechat_redirect']

    def parse(self, response):
        urls_ori = response.xpath('//*[@id="js_content"]/section[2]/section/section/section/section/section/section/section//a/@href').extract()
