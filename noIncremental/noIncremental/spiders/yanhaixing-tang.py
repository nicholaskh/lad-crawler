...
class WeChatSpider(scrapy.Spider):
    name = "yanhaixing"
    start_urls = ["https://mp.weixin.qq.com/s?__biz=MzIzMTcyMzY4OA==&mid=2247484358&idx=3&sn=80fbf27e8bcff4e3b8df4c8f37d2329f&scene=21#wechat_redirect"]

    def parse(self, response):
        urls_ori =  response.xpath('//*[@id="js_content"]/section[2]/section/section/section[2]/section/section/section/section/section/ol//a/@href').extract()
